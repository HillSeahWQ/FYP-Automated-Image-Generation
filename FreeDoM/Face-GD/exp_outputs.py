...
def main(
        img_ref_path = Path().cwd() / "images" / "2334.jpg",
        img_output_folder = Path().cwd() / "exp" / "conditions"
):
    # save_segmentation_map(img_ref_path, img_output_folder)
    # save_sketch(img_ref_path, img_output_folder)
    save_landmarks(img_ref_path=r"C:\Users\cliff\Hill\FYP-Automated-Image-Generation\FreeDoM\Face-GD\images\2334.jpg", img_output_folder=img_output_folder)
