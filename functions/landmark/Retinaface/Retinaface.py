...
# some global configs
trained_model=os.path.join(os.path.dirname(os.path.abspath(__file__)), "weights", "mobilenet0.25_Final.pth") # changed from '/workspace/ddgm/functions/landmark/Retinaface/weights/mobilenet0.25_Final.pth'
network='mobile0.25'
